...
<ul class="layui-nav" lay-filter="">
    ...
    <li class="layui-nav-item layui-this" style="margin-left: 100px"><a href="index.php">首页</a></li>
...
<div id="yi">
<div id="zuo">
    <a href="chanpingxiangqing.php?pro_id=<?php echo $results['pro_id']?>"><img src="<?php echo $results['pro_path']?>"></a>
<a href="chanpingxiangqing.php?pro_id=<?php echo $results['pro_id']?>"><p align="right" class="jg">￥<?php echo @$results['price'] ?></p></a>
<p align="center" class="zt"><a href="chanpingxiangqing.php?pro_id=<?php echo $results['pro_id']?>"> <?php echo $results['pro_name'] ?></a></p>
<p align="center" class="xzt"><a href="chanpingxiangqing.php?pro_id=<?php echo $results['pro_id']?>"> <?php echo @$results['commit'] ?></a></p>
</div>
<div id="zhong">
<p align="center" class="bt">热门景点</p>
<p align="center" class="xbt">POPULAR&nbsp;DESTINATION</p><br/>
<a href="chanpingxiangqing.php?pro_id=<?php echo $results['pro_id']?>"><p align="center" class="jg">more&nbsp;&nbsp;&nbsp;&nbsp;></p></a><br/><br/>
    <?php $results=mysqli_fetch_assoc($result); ?>
<a href="chanpingxiangqing.php?pro_id=<?php echo $results['pro_id']?>"> <img src="<?php echo $results['pro_path'] ?>" width="356" height="271"></a>
<a href="chanpingxiangqing.php?pro_id=<?php echo $results['pro_id']?>"><p align="right" class="jg">￥<?php echo @$results['price'] ?></p></a>
<p align="center" class="zt"> <a href="chanpingxiangqing.php?pro_id=<?php echo $results['pro_id']?>"> <?php echo $results['pro_name'] ?></a></p>
    <p align="center" class="xzt"><a href="chanpingxiangqing.php?pro_id=<?php echo $results['pro_id']?>"> <?php echo @$results['commit'] ?></a></p>
</div>
...
<br/><br/><br/><br/>
    <?php $results=mysqli_fetch_assoc($result); ?>
<a href="chanpingxiangqing.php?pro_id=<?php echo $results['pro_id']?>"><img src="<?php echo $results['pro_path'] ?>" width="349" height="270"></a>
    <a href="chanpingxiangqing.php?pro_id=<?php echo $results['pro_id']?>"><p align="right" class="jg">￥<?php echo @$results['price'] ?></p></a>
<p align="center" class="zt"><a href="chanpingxiangqing.php?pro_id=<?php echo $results['pro_id']?>"> <?php echo @$results['pro_name'] ?></a></p>
    <p align="center" class="xzt"><a href="chanpingxiangqing.php?pro_id=<?php echo $results['pro_id']?>"> <?php echo @$results['commit'] ; ?></a></p>
</div>
...
<div id="ezuo">
    ...
    <a href="chanpingxiangqing.php?pro_id=<?php echo $results['tehui_id']?>"> <img src="<?php echo $results['pro_path']?>"></a>
	<div id="w1">
        <p align="center" class="ss"><a href="chanpingxiangqing.php?pro_id=<?php echo $results['tehui_id']?>"> <?php echo $results['pro_name'] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a> </p>
        <p align="center" class="dc"><a href="chanpingxiangqing.php?pro_id=<?php echo $results['tehui_id']?>"> <?php echo $results['commit'] ?></a></p>
	</div>
	<div id="an1" align="left"><a href="chanpingxiangqing.php?pro_id=<?php echo $results['tehui_id']?>"><input class="button1" type="button" value="立即预定"/></a></div>
  </div>
<div id="eyou">
	<div id="ys">
	<div id="ys1">
        <?php $results=mysqli_fetch_assoc($result); ?>
        <div><a href="chanpingxiangqing.php?pro_id=<?php echo $results['tehui_id']?>"> <img src="<?php echo @$results['pro_path']?>"></a></div>
        <p align="center" class="xg"><a href="chanpingxiangqing.php?pro_id=<?php echo $results['tehui_id']?>" > <?php echo @$results['pro_name']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></p>
